<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.groupName" placeholder="名称" style="width: 200px;" class="filter-item"/>
    ...
    <el-table
      ...
      <el-table-column label="分组名" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="操作" width="250px" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button type="primary" icon="el-icon-document" @click="editPermission(scope.row.id)">编辑权限</el-button>
        </template>
      </el-table-column>
    </el-table>
    <pagination
...
<script>
import { getList, deletedCase } from '@/api/system/group'
...
export default {
  ...
  methods: {
    ...
    editPermission(id) {
      this.$router.push({ path: '/group/editMenuPerm' })
    },
